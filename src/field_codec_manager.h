...
dccl::FieldCodecManagerLocal::add(const std::string& name)
{
    ...
    add_single_type<Codec>(__mangle_name(name, std::string(Codec::wire_type::descriptor()->full_name())),
...
dccl::FieldCodecManagerLocal::remove(const std::string& name)
{
    ...
    remove_single_type<Codec>(__mangle_name(name, std::string(Codec::wire_type::descriptor()->full_name())),
                              google::protobuf::FieldDescriptor::TYPE_MESSAGE,
                              google::protobuf::FieldDescriptor::CPPTYPE_MESSAGE);
}
