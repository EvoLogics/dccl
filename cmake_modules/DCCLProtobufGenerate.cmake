# Custom DCCL protobuf code generation functions.
# These override the system protobuf_generate_cpp to add DCCL-specific
# behavior (custom proto paths, DCCL plugin invocation, clang analyzer guards).
#
# Must be included AFTER find_package(Protobuf).
...
function(PROTOBUF_GENERATE_CPP_INTERNAL USE_DCCL LOAD_FILE SRCS HDRS)
  ...
  foreach(FIL ${ARGN})
    ...
    # TODO: this leaks directory-scope state; would need a target parameter
    # to use target_include_directories instead.
